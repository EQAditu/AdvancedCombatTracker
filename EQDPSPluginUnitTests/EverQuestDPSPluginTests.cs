...
namespace EQDPSPluginUnitTests
{
    ...
    public sealed class EverQuestDPSPluginTests
    {
        ...
        [DataRow("`s pet's frost", EverQuestSwingType.DamageShield)]
        [DataRow("`s pet's flames",EverQuestSwingType.DamageShield)]
        [DataRow("`s pet's thorns", EverQuestSwingType.DamageShield)]
        [DataRow("`s ward's flames", EverQuestSwingType.DamageShield)]
        [DataRow("`s ward's thorns", EverQuestSwingType.DamageShield)]
        [DataRow("`s warder's thorns", EverQuestSwingType.DamageShield)]
        [DataRow("`s warder's flames", EverQuestSwingType.DamageShield)]
        [DataRow("`s warder's frost", EverQuestSwingType.DamageShield)]
        [DataRow("`s familiar's frost", EverQuestSwingType.DamageShield)]
        [DataRow("`s familiar's flames", EverQuestSwingType.DamageShield)]
        [DataRow("`s familiar's thorns", EverQuestSwingType.DamageShield)]
        [DataRow("`s pet's frost", EverQuestSwingType.Pet)]
        [DataRow("`s pet's flames", EverQuestSwingType.Pet)]
        [DataRow("`s pet's thorns", EverQuestSwingType.Pet)]
        [DataRow("`s ward's frost", EverQuestSwingType.Ward)]
        [DataRow("`s ward's flames", EverQuestSwingType.Ward)]
        [DataRow("`s ward's thorns", EverQuestSwingType.Ward)]
        [DataRow("`s warder's thorns", EverQuestSwingType.Warder)]
        [DataRow("`s warder's flames", EverQuestSwingType.Warder)]
        [DataRow("`s warder's frost", EverQuestSwingType.Warder)]
        [DataRow("`s familiar's frost", EverQuestSwingType.Familiar)]
        [DataRow("`s familiar's flames", EverQuestSwingType.Familiar)]
        [DataRow("`s familiar's thorns", EverQuestSwingType.Familiar)]
        [TestCategory("Plugin Tests")]
