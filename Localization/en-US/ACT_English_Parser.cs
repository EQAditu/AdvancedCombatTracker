...
namespace ACT_Plugin
{
	...
	"ctive)";
			...
			CombatantData.SwingTypeToDamageTypeDataLinksIncoming = new SortedDictionary<int, List<string>>
		{
			...
			MasterSwing.ColumnDefs.Add("RelativeTime", new MasterSwing.ColumnDef("RelativeTime", true, "FLOAT", "RelativeTime", (Data) => { return (Data.Time - Data.ParentEncounter.StartTime).ToString("T"); }, (Data) => { return (Data.Time - Data.ParentEncounter.StartTime).TotalSeconds.ToString(); }, (Left, Right) => { return Left.Time.CompareTo(Right.Time); }));
