...
namespace ActLocalization
{
...
#endif
	{
		...
		internal static void EditLocalizations()
		{
			...
			TryEditLocalization("helpPanel-soundTts-linkTtsCpl", "Opens the classic Text To Speech Control Panel applet.  The Windows 10 Settings app only affects UWP apps, not ACT."); // 
